...
const errorLogPath = join(__basesrcdir, "/logs/errors");
const combinedLogPath = join(__basesrcdir, "/logs/combined");

const { ENV, ENVIRONMENTS, LOG_LEVELS, LOG_CONFIG, ENABLE_DEBUG_LOGS } = commonConstants;
