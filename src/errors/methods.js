...
const { ERROR, LOG_LEVELS } = commonConstants;
...
/**
 * Method for throwing "unprocessable entity" error
 * @param {string} message Error message
 * @param {boolean} [isOperational] Determines whether our app throws error intentionally or its unhandled rejection. Default true
 * */
const throwUnprocessableEntityError = (message, isOperational = true) => {
    throw new AppError(LOG_LEVELS.ERROR, ERROR.UNPROCESSABLE_ENTITY.TYPE, message, ERROR.UNPROCESSABLE_ENTITY.CODE, isOperational);
};
